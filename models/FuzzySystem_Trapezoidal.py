...
# Service
S_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=2, d=3), term="poor")
S_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=3, b=4, c=6, d=7), term="average")
S_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=9, c=10, d=10), term="wonderful")
...
# Food quality
F_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=2, d=3), term="bad")
F_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=3, b=4, c=6, d=7), term="average")
F_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=9, c=10, d=10), term="wonderful")
...
# Decor
D_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=2, d=3), term="poor")
D_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=3, b=4, c=6, d=7), term="average")
D_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=9, c=10, d=10), term="wonderful")
FS.add_linguistic_variable("decor", sf.LinguisticVariable([D_1, D_2, D_3], concept="Interior Decor", universe_of_discourse=[0,10]))

# Location
L_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=2, d=3), term="bad")
L_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=3, b=4, c=6, d=7), term="average")
L_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=9, c=10, d=10), term="wonderful")
FS.add_linguistic_variable("location", sf.LinguisticVariable([L_1, L_2, L_3], concept="Location", universe_of_discourse=[0,10]))

# Price
P_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=2, d=3), term="high")
P_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=3, b=4, c=6, d=7), term="average")
P_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=9, c=10, d=10), term="low")
FS.add_linguistic_variable("price", sf.LinguisticVariable([P_1, P_2, P_3], concept="Prices", universe_of_discourse=[0,10]))

# Tip
T_1 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=0, b=0, c=5, d=7), term="low")
T_2 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=7, b=11, c=14, d=18), term="medium")
T_3 = sf.FuzzySet(function=sf.Trapezoidal_MF(a=18, b=22, c=25, d=25), term="high")
FS.add_linguistic_variable("tip", sf.LinguisticVariable([T_1, T_2, T_3],
                                                        concept="Tip Amount", universe_of_discourse=[0,25]))
...
def custom_aggregation(sets):
    if isinstance(sets[0], float):
        return sum(sets) / len(sets)
    else:
        values = [set.membership_value for set in sets]
...
def test_system(service, food_quality, decor, location, price):
    ...
    result = FS.inference(aggregation_function=custom_aggregation)["tip"]
    return result
...
with open('../results/results_Trapezoidal.txt', 'w') as f:
